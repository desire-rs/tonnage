...
pub const EXEMPT_ROUTES: &[&str] = &["/", "/signin", "/signup", "/hello", "/assets", "/images", "/videos" ,"/db_init"];
...
pub static UPLOAD_PATH: Lazy<String> =
  Lazy::new(|| env::var("UPLOAD_PATH").expect("UPLOAD_PATH must be set"));
